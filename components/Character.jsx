...
const Character = ({ idCh, nameCharacter, speciesCh, originCh, imageCh }) => {
    ...
    return (
        <div className="m-5 pb-12 sm:pb-9 bg-emerald-600 flex flex-col items-center justify-center text-center w-7/12 sm:w-56 border-4 border-lime-300 rounded-lg">
